...
from app.routes import auth, weather, predict, analytics, alerts, user, settings, search, insights
...
app.include_router(insights.router, prefix="/insights", tags=["Intelligence"])
